      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid gap-8 md:grid-cols-3">
          {steps.map((step, index) => {
            ...
            return (
              <Card key={index} className="border-border bg-card relative overflow-hidden group hover:border-[#874FFF]/50 transition-colors">
                <CardContent className="p-6">
                  <div className="flex items-center justify-between mb-4">
                    <div className="inline-flex h-12 w-12 items-center justify-center rounded-lg bg-[#874FFF]/10">
                      <Icon className="h-6 w-6 text-[#874FFF]" />
                    </div>
                    <span className="text-xs font-medium text-[#874FFF] bg-[#874FFF]/10 px-3 py-1 rounded-full">
                      {step.highlight}
                    </span>
                  </div>
